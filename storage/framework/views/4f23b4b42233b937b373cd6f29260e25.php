...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/doctor_dashboard_1_style.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('css/doctor_dashboard_1_styleguide.css')); ?>" />
                        ...
                        <div class="sidebar-item">
                            <div class="sidebar-link-container">
                                <div class="jammedical">
                                    <img class="logo-icon" alt="" src="<?php echo e(asset('images/jam_medical.svg')); ?>" />
                                </div>
                            </div>
                        </div>
                ...
                <div class="sidebar-links">
                    <button class="dashboard-sidebar-link">
                        <div class="link-items">
                            <img class="tablerfile-report-icon" alt="" src="<?php echo e(asset('images/upload.svg')); ?>" />
                            <div class="upload-prescription">Patient List</div>
                        </div>
                    </button>
                    <div class="dashboard-sidebar-link1">
                        <div class="tablerfile-report-parent">
                            <img class="tablerfile-report-icon1" alt="" src="<?php echo e(asset('images/report.svg')); ?>" />
            ...
            <header class="dashboard-nav">
                <div class="profile-settings-notification">
                    ...
                    <div class="user-image-parent">
                        <img class="user-image-icon" alt="" src="<?php echo e(asset('images/Frame 310.png')); ?>" />

                        <div class="name-container">
                            <a class="doctor-name">Doctor Name</a>
                            <img class="vector-icon" alt="" src="<?php echo e(asset('images/Vector.svg')); ?>" />
                        </div>
                    </div>
                </div>
                        ...
                        <div class="list-container">
                            ...
                            <div class="patient-details">
                                ...
                                <div class="patient-avatar">
                                    <img class="avatar-icon" alt="" src="<?php echo e(asset('images/Ellipse 22.png')); ?>" />
...
<?php /**PATH K:\VS Code Laravel\demo-app\resources\views/docdash.blade.php ENDPATH**/ ?>