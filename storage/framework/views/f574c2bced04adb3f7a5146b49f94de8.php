...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/patient_dashboard_6_style.css')); ?>" />
    <link rel="stylesheet" href="<?php echo e(asset('css/patient_dashboard_6_styleguide.css')); ?>" />
                ...
                <div class="prescription-list">
                    ...
                    <div class="prescription-items">
                        <div class="prescription-item-content-parent">
                            <img class="prescription-item-content" alt="" src="<?php echo e(asset('images/Ellipse 27.svg')); ?>" />
                    ...
                    <div class="prescription-items2">
                        <div class="ellipse-parent">
                            <img class="frame-item" alt="" src="<?php echo e(asset('images/Ellipse 27.svg')); ?>" />
                    ...
                    <div class="prescription-items4">
                        <div class="ellipse-group">
                            <img class="frame-inner" alt="" src="<?php echo e(asset('images/Ellipse 27.svg')); ?>" />
                    ...
                    <footer class="prescription-items6">
                        <div class="ellipse-container">
                            <img class="ellipse-icon" alt="" src="<?php echo e(asset('images/Ellipse 27.svg')); ?>" />
                    ...
                    <div class="prescription-items7">
                        <div class="frame-parent6">
                            <div class="frame-parent7">
                                ...
                                <img class="carbonreport-icon4" alt="" src="<?php echo e(asset('images/carbon_report_1.svg')); ?>" />
                            </div>
...
<?php /**PATH K:\VS Code Laravel\demo-app\resources\views/patdash3.blade.php ENDPATH**/ ?>