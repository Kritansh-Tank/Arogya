...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/doctor_registration_style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/doctor_registration_styleguide.css')); ?>">
...
<body>
    <div class="doctor-register">
            ...
            <div class="logo-group">
                <div class="logo-container">
                    <div class="jammedical">
                        <img class="logo-icon" alt="" src="<?php echo e(asset('images/Frame 501.svg')); ?>" />
                    </div>
                </div>
        ...
        <main class="content">
            <section class="body">
                <div class="header">
                    <img class="navigation-icon" alt="" src="<?php echo e(asset('images/Frame 1368.png')); ?>" />
                </div>
...
<?php /**PATH K:\VS Code Laravel\demo-app\resources\views/doctor.blade.php ENDPATH**/ ?>