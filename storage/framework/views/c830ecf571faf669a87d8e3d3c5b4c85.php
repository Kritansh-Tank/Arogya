...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/qf_style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/qf_styleguide.css')); ?>">
                ...
                <div class="frame-parent">
                    <div class="location-icon-container-parent">
                        ...
                        <div class="user-avatar-wrapper">
                            <img class="user-avatar-icon" alt="" src="<?php echo e(asset('images/Frame 90596.svg')); ?>" />
                        </div>
                    </div>
                            ...
                            <div class="happy-customers-content">
                                <div class="frame-parent1">
                                    <div class="frame-parent2">
                                        <div class="ellipse-parent">
                                            <img class="frame-item" alt="" src="<?php echo e(asset('images/Ellipse 15.png')); ?>" />

                                            <img class="frame-inner" alt="" src="<?php echo e(asset('images/Ellipse 16.png')); ?>" />

                                            <img class="ellipse-icon" alt="" src="<?php echo e(asset('images/Ellipse 17.png')); ?>" />

                                            <img class="frame-child1" alt="" src="<?php echo e(asset('images/Ellipse 18.png')); ?>" />

                                            <img class="frame-child2" alt="" src="<?php echo e(asset('images/Ellipse 19.png')); ?>" />

                                            <img class="frame-child3" alt="" src="<?php echo e(asset('images/Ellipse 20.png')); ?>" />

                                            <img class="frame-child4" alt="" src="<?php echo e(asset('images/Ellipse 21.png')); ?>" />
                                        </div>
                                ...
                                <div class="appointment-type-columns-parent">
                                    ...
                                    <div class="appointment-type-columns1">
                                        <img class="appointment-type-columns-child" alt="" src="<?php echo e(asset('images/Line 4.svg')); ?>" />
                                    </div>
                                    ...
                                    <div class="appointment-type-columns3">
                                        <img class="appointment-type-columns-item" alt="" src="<?php echo e(asset('images/Line 4.svg')); ?>" />
                                    </div>
                        ...
                        <div class="appointment-preference-contain-parent">
                            <div class="appointment-preference-contain">
                                ...
                                <div class="booking-option-column-parent">
                                    ...
                                    <a href="<?php echo e(route('qf')); ?>">
                                        <div class="frame-wrapper3">
                                            <img class="booking-option-column-child" alt=""
                                                src="<?php echo e(asset('images/Frame 1277.svg')); ?>" />
                                ...
                                <div class="inputs-fields">
                                    <div class="input-fields-comp">
                                        <div class="select-city-wrapper">
                                            <input class="select-city" placeholder="Name" type="text" />
                                        </div>
                                    </div>
                                    ...
                                    <textarea class="input-fields-comp3" placeholder="Message" rows="{7}"
                                        cols="{18}"></textarea>
                                </div>
                                <button class="input-fields-comp4">
                                    <div class="select-city-wrapper1">
                                        <div class="select-city3">Send Query</div>
                                    </div>
                                </button>
                            </div>
                        </div>
                            ...
                            <div class="logo-group1">
                                <div class="jammedical-container">
                                    <div class="jammedical1">
                                        <img class="vector-icon2" alt="" src="<?php echo e(asset('images/Vector-8.svg')); ?>" />
                                    </div>
                                </div>
...
<?php /**PATH K:\VS Code Laravel\demo-app\resources\views/qf.blade.php ENDPATH**/ ?>