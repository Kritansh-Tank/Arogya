...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset('css/registration_style.css')); ?>">
    <link rel="stylesheet" href="<?php echo e(asset('css/registration_styleguide.css')); ?>">
...
<body>
    <div class="register">
            ...
            <div class="logo-group">
                <div class="logo-container">
                    <div class="jammedical">
                        <img class="logo-shape-icon" alt="" src="<?php echo e(asset('images/Vector-8.svg')); ?>" />
                    </div>
                </div>
        ...
        <section class="body">
            <div class="content">
                <img class="left-panel-icon" alt="" src="<?php echo e(asset('images/Frame 1368.png')); ?>" />
                            ...
                            <div class="login-button-container">
                                ...
                                <a href="<?php echo e(route('registration')); ?>">
                                    <div class="register-button-container">
                                        <img class="register-button-wrapper" alt="" src="<?php echo e(asset('images/Frame 1277.svg')); ?>" />
...
<?php /**PATH K:\VS Code Laravel\demo-app\resources\views/registration.blade.php ENDPATH**/ ?>