...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/login_styleguide.css') }}">
            ...
            <div class="logo-group">
                <div class="jam-medical-logo">
                    <div class="jammedical">
                        <img class="jam-medical-icon" alt="" src="{{ asset('images/Frame 501.svg') }}" />
                    </div>
                </div>
            ...
            <div class="welcome-title-parent">
                ...
                <div class="description">
                    <div class="services-description-parent">
                        ...
                        <div class="benefits">
                            <div class="customer-benefits">
                                <div class="happy-customers-icons">
                                    <img class="customer-icons" alt="" src="{{ asset('images/Ellipse 15.png') }}" />
                                    <img class="customer-icons1" alt="" src="{{ asset('images/Ellipse 16.png') }}" />
                                    <img class="customer-icons2" alt="" src="{{ asset('images/Ellipse 17.png') }}" />
                                    <img class="customer-icons3" alt="" src="{{ asset('images/Ellipse 18.png') }}" />
                                    <img class="customer-icons4" alt="" src="{{ asset('images/Ellipse 19.png') }}" />
                                    <img class="customer-icons5" alt="" src="{{ asset('images/Ellipse 20.png') }}" />
                                    <img class="customer-icons6" alt="" src="{{ asset('images/Ellipse 21.png') }}" />
                                </div>
                        ...
                        <img class="empty-benefit-icon" alt="" src="{{ asset('images/Frame 1368.png') }}" />
                    </div>
                    <div class="login-instructions-parent">
                        <div class="login-instructions">
                            <img class="login-notice-icon" alt="" src="{{ asset('images/border.svg') }}" />
                            ...
                            <div class="login-form-fields">
                                <a href="{{ url('/') }}">
                                    <div class="login-button">
                                        <img class="login-button-icon" alt="" src="{{ asset('images/Frame 1277.svg') }}" />
