...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/patient_dashboard_2_style.css') }}" />
    <link rel="stylesheet" href="{{ asset('css/patient_dashboard_2_styleguide.css') }}" />
                        ...
                        <div class="frame-wrapper">
                            <div class="jammedical-wrapper">
                                <div class="jammedical">
                                    <img class="vector-icon" loading="lazy" alt="" src="{{ asset('images/jam_medical.svg') }}" />
                                </div>
                            </div>
                        </div>
        ...
        <section class="user-panel">
            <header class="dashboard-nav">
                <div class="profile-settings-notification">
                    ...
                    <div class="user-name">
                        <img class="user-name-container" alt="" src="{{ asset('images/Frame 310.png') }}" />

                        <div class="patient-name-parent">
                            <a class="patient-name">Patient Name</a>
                            <img class="user-name-icon" alt="" src="{{ asset('images/Vector.svg') }}" />
                        </div>
                    </div>
                </div>
                ...
                <div class="main-container">
                                            ...
                                            <div class="patient-upload-report-cards-inner">
                                                <div class="frame-container">
                                                    <div class="ellipse-parent">
                                                        <img class="frame-child" alt="" src="{{ asset('images/Ellipse 22.png') }}" />
                                    ...
                                    <div class="doctor-card-instance-container-wrapper">
                                        <div class="doctor-card-instance-container">
                                            <div class="doctor-card-instance-items">
                                                <img class="doctor-instance-avatar" alt="" src="{{ asset('images/Ellipse 22.png') }}" />
                    ...
                    <div class="upload-container-wrapper">
                        <div class="upload-container">
                            <img class="drag-and-drop-icon" alt="" src="{{ asset('images/Vector-5.svg') }}" />
