...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/hp_style.css') }}">
    <link rel="stylesheet" href="{{ asset('css/hp_styleguide.css') }}">
...
<body>
                        ...
                        <div class="location">
                            <div class="location-details">
                                ...
                                <div class="vector-wrapper">
                                    <img class="vector-icon" alt="" src="{{ asset('images/Frame 90596.svg') }}" />
                                </div>
                            </div>
                            <div class="user">
                                <img class="user-profile-icon" alt="" src="{{ asset('images/Frame 1324-1.png') }}" />
                        ...
                        <div class="filter-search">
                            ...
                            <div class="filter-search-group">
                                <button class="packages-search-bar">
                                    <img class="iconamoonsearch-light" alt="" src="{{ asset('images/iconamoon_search-light.svg') }}" />

                                    <a class="search">Search</a>
                                </button>
                                <div class="filters">
                                    <a class="filters1">Filters</a>
                                    <img class="solarfilter-linear-icon" alt="" src="{{ asset('images/solar_filter-linear.svg') }}" />
                                </div>
                            </div>
                        </div>
                                                ...
                                                <div class="price-frame">
                                                    ...
                                                    <div class="price-value-container">
                                                        <div class="rs-1000-parent">
                                                            ...
                                                            <img class="price-divider-icon" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="package-pricing">
                                                    ...
                                                    <div class="original-price-container">
                                                        <div class="rs-1000-container">
                                                            ...
                                                            <img class="original-price-divider" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="frame-parent16">
                                                        <div class="frame-parent17">
                                                            ...
                                                            <div class="primeclock-frame">
                                                                <img class="primeclock-icon3" alt="" src="{{ asset('images/prime_clock.svg') }}" />
                                                            </div>
                                                        ...
                                                        <div class="frame-parent18">
                                                            ...
                                                            <div class="mdirun-fast-frame">
                                                                <img class="mdirun-fast-icon3" alt="" src="{{ asset('images/Vector-3.svg') }}" />
                                                            </div>
                                                ...
                                                <div class="price-frame2">
                                                    ...
                                                    <div class="price-frame-child">
                                                        <div class="rs-1000-parent1">
                                                            ...
                                                            <img class="frame-child6" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="frame-parent25">
                                                        <div class="frame-parent26">
                                                            ...
                                                            <div class="primeclock-wrapper1">
                                                                <img class="primeclock-icon4" alt="" src="{{ asset('images/prime_clock.svg') }}" />
                                                            </div>
                                                        ...
                                                        <div class="frame-parent27">
                                                            ...
                                                            <div class="mdirun-fast-wrapper1">
                                                                <img class="mdirun-fast-icon4" alt="" src="{{ asset('images/Vector-3.svg') }}" />
                                                            </div>
                                                ...
                                                <div class="price-frame3">
                                                    ...
                                                    <div class="price-frame-inner1">
                                                        <div class="rs-1000-parent2">
                                                            ...
                                                            <img class="frame-child10" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="frame-parent33">
                                                    <div class="frame-parent34">
                                                        ...
                                                        <div class="primeclock-wrapper2">
                                                            <img class="primeclock-icon5" alt="" src="{{ asset('images/prime_clock.svg') }}" />
                                                        </div>
                                                    ...
                                                    <div class="frame-parent35">
                                                        ...
                                                        <div class="mdirun-fast-wrapper2">
                                                            <img class="mdirun-fast-icon5" alt="" src="{{ asset('images/Vector-3.svg') }}" />
                                                        </div>
                                            ...
                                            <div class="package-container1">
                                                    ...
                                                    <div class="package-pricing1">
                                                        ...
                                                        <div class="original-price-container1">
                                                            <div class="rs-1000-parent3">
                                                                ...
                                                                <img class="original-price-divider1" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <button class="book-appointment-btn12"  id="bookAppointmentBtn6">
                                                    ...
                                                    <div class="fearrow-up-wrapper3">
                                                        <img class="fearrow-up-icon5" alt="" src="{{ asset('images/fe_arrow-up.svg') }}g" />
                                                    </div>
                                                </button>
                                            </div>
                                        </div>
                                                    ...
                                                    <div class="frame-parent42">
                                                        <div class="frame-parent43">
                                                            ...
                                                            <div class="primeclock-wrapper3">
                                                                <img class="primeclock-icon6" alt="" src="{{ asset('images/prime_clock.svg') }}" />
                                                            </div>
                                                        ...
                                                        <div class="frame-parent44">
                                                            ...
                                                            <div class="mdirun-fast-wrapper3">
                                                                <img class="mdirun-fast-icon6" alt="" src="{{ asset('images/Vector-3.svg') }}" />
                                                            </div>
                                                ...
                                                <div class="price-frame4">
                                                    ...
                                                    <div class="price-frame-inner2">
                                                        <div class="rs-1000-parent4">
                                                            ...
                                                            <img class="frame-child17" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                                ...
                                                <div class="frame-parent50">
                                                    <div class="frame-parent51">
                                                        ...
                                                        <div class="primeclock-wrapper4">
                                                            <img class="primeclock-icon7" alt="" src="{{ asset('images/prime_clock.svg') }}" />
                                                        </div>
                                                    ...
                                                    <div class="frame-parent52">
                                                        ...
                                                        <div class="mdirun-fast-wrapper4">
                                                            <img class="mdirun-fast-icon7" alt="" src="{{ asset('images/Vector-3.svg') }}" />
                                                        </div>
                                        ...
                                        <div class="frame-parent54">
                                                ...
                                                <div class="price-frame5">
                                                    ...
                                                    <div class="price-frame-inner3">
                                                        <div class="rs-1000-parent5">
                                                            ...
                                                            <img class="frame-child21" alt=""  src="{{ asset('images/Line 1.svg') }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <button class="book-appointment-btn16" id="bookAppointmentBtn8">
                                                ...
                                                <div class="fearrow-up-wrapper5">
                                                    <img class="fearrow-up-icon7" alt="" src="{{ asset('images/fe_arrow-up.svg') }}" />
                                                </div>
                                            </button>
                                        </div>
                                    </div>
                                                ...
                                                <div class="frame-parent58">
                                                    <div class="frame-parent59">
                                                        ...
                                                        <div class="primeclock-wrapper5">
                                                            <img class="primeclock-icon8" alt="" src="{{ asset('images/prime_clock.svg') }}" />
                                                        </div>
                                                    ...
                                                    <div class="frame-parent60">
                                                        ...
                                                        <div class="mdirun-fast-wrapper5">
                                                            <img class="mdirun-fast-icon8" alt="" src="{{ asset('images/Vector-3.svg') }}" />
                                                        </div>
                                            ...
                                            <div class="frame-parent63">
                                                    ...
                                                    <div class="price-frame6">
                                                        ...
                                                        <div class="price-frame-inner4">
                                                            <div class="rs-1000-parent6">
                                                                ...
                                                                <img class="frame-child25" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                                                <button class="book-appointment-btn18" id="bookAppointmentBtn9">
                                                    ...
                                                    <div class="fearrow-up-wrapper6">
                                                        <img class="fearrow-up-icon8" alt="" src="{{ asset('images/fe_arrow-up.svg') }}" />
                                                    </div>
                                                </button>
                                            </div>
                                        </div>
                    ...
                    <div class="logo-group1">
                        <div class="brand-icon-container">
                            <div class="jammedical1">
                                <img class="icon-path" alt="" src="{{ asset('images/Vector-8.svg') }}" />
                            </div>
                        </div>
    ...
    <script src="{{ asset('js/hp_nav.js') }}"></script>
