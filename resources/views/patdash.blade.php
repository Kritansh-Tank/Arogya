...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/patient_dashboard_1_style.css') }}" />
    <link rel="stylesheet" href="{{ asset('css/patient_dashboard_1_styleguide.css') }}" />
            ...
            <header class="dashboard-nav">
                <div class="profile-settings-notification">
                    <div class="settings-notification">
                        <img class="solarsettings-outline-icon" src="{{ asset('images/solar_settings-outline.svg') }}" />
                    ...
                    <div class="user-profile">
                        <img class="user-profile-image" alt="" src="{{ asset('images/Frame 310.png') }}" />
                                            ...
                                            <div class="doctor-card-container">
                                                <div class="doctor-card-info">
                                                    ...
                                                    <div class="doctor-location">
                                                        <img class="mdilocation-icon" alt="" src="{{ asset('images/Vector-2.svg') }}" />
                                        ...
                                        <div class="patient-upload-report-cards-inner">
                                            <div class="frame-div">
                                                <div class="ellipse-parent">
                                                    <img class="doctor-profile-pic" alt="" src="{{ asset('images/Ellipse 22.png') }}" />
                                                ...
                                                <div class="mdilocation-parent">
                                                    <img class="mdilocation-icon1" alt="" src="{{ asset('images/Vector-2.svg') }}" />
                                        ...
                                        <div class="patient-upload-report-cards-child">
                                            <div class="frame-parent1">
                                                <div class="ellipse-group">
                                                    <img class="frame-item" alt="" src="{{ asset('images/Ellipse 22.png') }}" />
                                                ...
                                                <div class="mdilocation-group">
                                                    <img class="mdilocation-icon2" alt="" src="{{ asset('images/Vector-2.svg') }}" />
                                        ...
                                        <div class="patient-upload-report-cards-inner1">
                                            <div class="frame-parent2">
                                                <div class="ellipse-container">
                                                    <img class="frame-inner" alt="" src="{{ asset('images/Ellipse 22.png') }}" />
                                                ...
                                                <div class="mdilocation-container">
                                                    <img class="mdilocation-icon3" alt="" src="{{ asset('images/Vector-2.svg') }}" />
                                        ...
                                        <div class="patient-upload-report-cards-inner2">
                                            <div class="frame-parent3">
                                                <div class="ellipse-parent1">
                                                    <img class="ellipse-icon" alt="" src="{{ asset('images/Ellipse 22.png') }}" />
                                                ...
                                                <div class="mdilocation-parent1">
                                                    <img class="mdilocation-icon4" alt="" src="{{ asset('images/Vector-2.svg') }}" />
