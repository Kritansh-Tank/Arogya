...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/tl_style.css') }}">
    <link rel="stylesheet" href="{{ asset('css/tl_styleguide.css') }}">
...
<body>
                ...
                <div class="logo-group" id="logoGroupContainer">
                    <div class="jammedical-wrapper">
                        <div class="jammedical">
                            <img class="logo-icon"  alt="" src="{{ asset('images/Vector-8.svg') }}" />
                        </div>
                    </div>
            ...
            <div class="offers-parent">
                <div class="offers">
                    <div class="offer-slider-section">
                        <img class="downloader-3-icon" alt="" src="{{ asset('images/Downloader 3.png') }}" />
                ...
                <div class="test-list">
                    <div class="test-cards">
                        <div class="book-test-card">
                            <img class="image-icon"  alt="" src="{{ asset('images/Downloader 6.png') }}" />
                                    ...
                                    <div class="prices">
                                        ...
                                        <div class="discounted-prices">
                                            <div class="old-prices">
                                                ...
                                                <img class="price-dividers-icon" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="book-test-card1">
                            <img class="image-icon1" alt="" src="{{ asset('images/Downloader 6.png') }}" />
                        ...
                        <div class="book-test-card2">
                            <img class="image-icon2" alt="" src="{{ asset('images/Downloader 6.png') }}" />
                                    ...
                                    <div class="price-frame1">
                                        ...
                                        <div class="price-frame-child">
                                            <div class="rs-1000-group">
                                                ...
                                                <img class="frame-child4" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="book-test-card3">
                            <img class="image-icon3" alt="" src="{{ asset('images/Downloader 6.png') }}" />
                                    ...
                                    <div class="price-frame2">
                                        ...
                                        <div class="price-frame-inner1">
                                            <div class="rs-1000-container">
                                                ...
                                                <img class="frame-child5" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="book-test-card4">
                            <img class="image-icon4" alt="" src="{{ asset('images/Downloader 6.png') }}" />
                        ...
                        <div class="book-test-card5">
                            <img class="image-icon5" alt="" src="{{ asset('images/Downloader 6.png') }}" />
                                    ...
                                    <div class="price-frame4">
                                        ...
                                        <div class="price-frame-inner3">
                                            <div class="rs-1000-parent2">
                                                ...
                                                <img class="frame-child7" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="book-test-card6">
                            <img class="image-icon6" alt="" src="{{ asset('images/Downloader 6.png') }}" />
                                    ...
                                    <div class="price-frame5">
                                        ...
                                        <div class="price-frame-inner4">
                                            <div class="rs-1000-parent3">
                                                ...
                                                <img class="frame-child8" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="book-test-card7">
                            <img class="image-icon7" alt="" src="{{ asset('images/Downloader 6.png') }}" />
                                    ...
                                    <div class="price-frame6">
                                        ...
                                        <div class="price-frame-inner5">
                                            <div class="rs-1000-parent4">
                                                ...
                                                <img class="frame-child9" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <div class="book-test-card8">
                            <img class="image-icon8" alt="" src="{{ asset('images/Downloader 6.png') }}" />
                    ...
                    <div class="logo-group1">
                        <div class="jammedical-container">
                            <div class="jammedical1">
                                <img class="footer-logo-icon" alt="" src="{{ asset('images/Vector-8.svg') }}" />
                            </div>
                        </div>
    ...
    <script src="{{ asset('js/tl_nav.js') }}"></script>
