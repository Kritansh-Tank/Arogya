...
<body>
    <div class="homepage">
            ...
            <div class="logo-group-parent">
                ...
                <div class="frame-parent">
                    <button class="book-appointment-wrapper">
                        <a href="{{ route('af') }}" class="book-appointment">Book Appointment</a>
                    </button>
                    <div class="frame-group">
                        <div class="frame-container">
                            ...
                            <div class="location-divider-wrapper">
                                <img class="location-divider-icon" alt="" src="{{ asset('images/Frame 90596.svg') }}" />
                            </div>
                        </div>
                        <div class="frame-div">
                            ...
                            <div class="hi-james-parent">
                                ...
                                <img class="user-dropdown-icon" id="user-dropdown-icon" alt="" src="{{ asset('images/Vector-7.svg') }}" />
                            </div>
        ...
        <section class="frame-section">
                    ...
                    <div class="frame-parent1">
                            ...
                            <div class="frame-parent2">
                                <div class="hero-search-content-wrapper">
                                    <div class="hero-search-content">
                                        <img class="iconoirsearch" alt="" src="{{ asset('images/Vector-4.svg') }}" />
                                ...
                                <div class="hero-search-icon-right">
                                    <div class="iconoirsearch1">
                                        <img class="vector-icon1" alt="" src="{{ asset('images/Vector-6.svg') }}" />
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="indicators-parent">
                            <div class="indicators">
                                <img class="indicator-dots-icon" alt="" src="{{ asset('images/Ellipse 15.png') }}" />

                                <img class="indicator-dots-icon1" alt="" src="{{ asset('images/Ellipse 16.png') }}" />

                                <img class="indicator-dots-icon2" alt="" src="{{ asset('images/Ellipse 17.png') }}" />

                                <img class="indicator-dots-icon3" alt="" src="{{ asset('images/Ellipse 18.png') }}" />

                                <img class="indicator-dots-icon4" alt="" src="{{ asset('images/Ellipse 19.png') }}" />

                                <img class="indicator-dots-icon5" alt="" src="{{ asset('images/Ellipse 20.png') }}" />

                                <img class="indicator-dots-icon6" alt="" src="{{ asset('images/Ellipse 21.png') }}" />
                            </div>
            ...
            <div class="vector-parent">
                <img class="frame-inner" alt="" src="{{ asset('images/Vector 11.png') }}" />
                ...
                <div class="new-basic-healt0packages-parent">
                                                ...
                                                <div class="frame-parent7">
                                                    <div class="frame-parent8">
                                                        ...
                                                        <div class="report-time-icons">
                                                            <img class="primeclock-icon" alt="" src="{{ asset('images/prime_clock.svg') }}" />
                                                        </div>
                                                    ...
                                                    <div class="frame-parent9">
                                                        ...
                                                        <div class="sample-collection-icons">
                                                            <img class="mdirun-fast-icon" alt="" src="{{ asset('images/Vector-3.svg') }}" />
                                                        </div>
                                    ...
                                    <div class="package-price">
                                            ...
                                            <div class="price">
                                                ...
                                                <div class="amount">
                                                    <div class="rupees">
                                                        ...
                                                        <img class="rupees-child" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <button class="book-appointment-btn1" id="bookAppointmentBtn1">
                                            ...
                                            <div class="fearrow-up-wrapper">
                                                <img class="fearrow-up-icon" alt="" src="{{ asset('images/fe_arrow-up.svg') }}" />
                                            </div>
                                        </button>
                                    </div>
                                </div>
                                                ...
                                                <div class="frame-parent15">
                                                    <div class="frame-parent16">
                                                        ...
                                                        <div class="primeclock-wrapper">
                                                            <img class="primeclock-icon1" alt="" src="{{ asset('images/prime_clock.svg') }}" />
                                                        </div>
                                                    ...
                                                    <div class="frame-parent17">
                                                        ...
                                                        <div class="mdirun-fast-wrapper">
                                                            <img class="mdirun-fast-icon1" alt="" src="{{ asset('images/Vector-3.svg') }}" />
                                                        </div>
                                    ...
                                    <div class="frame-parent19">
                                            ...
                                            <div class="price-frame">
                                                ...
                                                <div class="price-frame-inner">
                                                    <div class="rs-1000-parent">
                                                        ...
                                                        <img class="line-icon" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <button class="book-appointment-btn3" id="bookAppointmentBtn2">
                                            ...
                                            <div class="fearrow-up-container">
                                                <img class="fearrow-up-icon1" alt="" src="{{ asset('images/fe_arrow-up.svg') }}" />
                                            </div>
                                        </button>
                                    </div>
                                </div>
                                            ...
                                            <div class="frame-parent23">
                                                <div class="frame-parent24">
                                                    ...
                                                    <div class="primeclock-container">
                                                        <img class="primeclock-icon2" alt="" src="{{ asset('images/prime_clock.svg') }}" />
                                                    </div>
                                                ...
                                                <div class="frame-parent25">
                                                    ...
                                                    <div class="mdirun-fast-container">
                                                        <img class="mdirun-fast-icon2" alt="" src="{{ asset('images/Vector-3.svg') }}" />
                                                    </div>
                                        ...
                                        <div class="price-button1">
                                                ...
                                                <div class="price1">
                                                    ...
                                                    <div class="amount1">
                                                        <div class="rupees1">
                                                            ...
                                                            <img class="rupees-item" alt="" src="{{ asset('images/Line 1.svg') }}" />
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <button class="book-appointment-btn5" id="bookAppointmentBtn3">
                                                ...
                                                <div class="fearrow-up-frame">
                                                    <img class="fearrow-up-icon2" alt="" src="{{ asset('images/fe_arrow-up.svg') }}" />
                                                </div>
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <div class="next-btn">
                        <div class="eparrow-up-bold-wrapper">
                            <img class="eparrow-up-bold-icon" alt="" src="{{ asset('images/Frame 177.svg') }}" />
                        </div>
                        <img class="next-btn-child" alt="" src="{{ asset('images/Frame 174.svg') }}" />
                    </div>
                </div>
            </div>
        </section>
        <section class="checkups">
            ...
            <div class="checkup-list">
                <div class="test-packages-ui">
                    <img class="checkup-card-icon" alt="" src="{{ asset('images/Downloader 2.png') }}" />
                            ...
                            <div class="checkup-price">
                                ...
                                <button class="book-appointment-btn6" id="bookAppointmentBtn4">
                                    ...
                                    <div class="fearrow-up-wrapper1">
                                        <img class="fearrow-up-icon3" alt="" src="{{ asset('images/fe_arrow-up.svg') }}" />
                                    </div>
                                </button>
                            </div>
                        </div>
                ...
                <div class="test-packages-ui1">
                    <img class="test-packages-ui-child" alt="" src="{{ asset('images/Downloader 4.png') }}" />
                            ...
                            <div class="frame-parent28">
                                ...
                                <button class="book-appointment-btn7" id="bookAppointmentBtn5">
                                    ...
                                    <div class="fearrow-up-wrapper2">
                                        <img class="fearrow-up-icon4" alt="" src="{{ asset('images/fe_arrow-up.svg') }}" />
                                    </div>
                                </button>
                            </div>
                        </div>
                ...
                <div class="test-packages-ui2">
                    <img class="test-packages-ui-item" alt="" src="{{ asset('images/Downloader 5.png') }}" />
                            ...
                            <div class="frame-parent30">
                                ...
                                <button class="book-appointment-btn8" id="bookAppointmentBtn6">
                                    ...
                                    <div class="fearrow-up-wrapper3">
                                        <img class="fearrow-up-icon5" alt="" src="{{ asset('images/fe_arrow-up.svg') }}" />
                                    </div>
                                </button>
                            </div>
                        </div>
                ...
                <div class="test-packages-ui3">
                    <img class="frame-icon" alt="" src="{{ asset('images/Downloader 6.png') }}" />
                            ...
                            <div class="frame-parent32">
                                ...
                                <button class="book-appointment-btn9" id="bookAppointmentBtn7">
                                    ...
                                    <div class="fearrow-up-wrapper4">
                                        <img class="fearrow-up-icon6" alt="" src="{{ asset('images/fe_arrow-up.svg') }}" />
                                    </div>
                                </button>
                            </div>
                        </div>
            ...
            <div class="next-btn1">
                <div class="eparrow-up-bold-container">
                    <img class="eparrow-up-bold-icon1" alt="" src="{{ asset('images/Frame 177.svg') }}" />
                </div>
                <img class="next-btn-item" alt="" src="{{ asset('images/Frame 174.svg') }}" />
            </div>
        </section>
        <section class="why">
            <div class="content">
                        ...
                        <div class="reasons-list">
                            <div class="image-cricle-parent">
                                <img class="image-cricle-icon"   alt=""
                                    src="{{ asset('images/image-cricle.png') }}" />
                            ...
                            <div class="image-cricle-group">
                                <img class="image-cricle-icon1" alt="" src="{{ asset('images/image-cricle-1.png') }}" />
                            ...
                            <div class="image-cricle-container">
                                <img class="image-cricle-icon2" alt="" src="{{ asset('images/image-cricle-2.png') }}" />
        ...
        <section class="review-list">
            <div class="review-card">
                <div class="review-content">
                    <img class="avatar-icon"   alt="" src="{{ asset('images/Frame 1324.png') }}" />
                ...
                <div class="review-content1">
                    <img class="review-content-child" alt="" src="{{ asset('images/Frame 1324-1.png') }}" />
                ...
                <div class="review-content2">
                    <img class="review-content-item" alt="" src="{{ asset('images/Frame 1324-2.png') }}" />
                ...
                <div class="next-btn2">
                    <div class="eparrow-up-bold-frame">
                        <img class="eparrow-up-bold-icon2" alt="" src="{{ asset('images/Frame 177.svg') }}" />
                    </div>
                    <img class="next-btn-inner" alt="" src="{{ asset('images/Frame 174.svg') }}" />
                </div>
            </div>
        </section>
        <footer class="footer">
                    ...
                    <div class="logo-group1">
                        <div class="brand-name">
                            <div class="jammedical1">
                                <img class="brand-icon" alt="" src="{{ asset('images/Vector-8.svg') }}" />
                            </div>
                        </div>
    ...
    <script>
        window.afUrl = "{{ route('af') }}";
    </script>
    <script src="{{ asset('js/home_nav.js') }}"></script>
